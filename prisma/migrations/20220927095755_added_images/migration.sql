/*
  ...
  - Added the required column `techniqueImage` to the `Technique` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Category" ("createdAt", "createdByUserId", "id", "name", "updatedAt", "updatedByUserId") SELECT "createdAt", "createdByUserId", "id", "name", "updatedAt", "updatedByUserId" FROM "Category";
DROP TABLE "Category";
...
INSERT INTO "new_Technique" ("categoryId", "createdAt", "createdByUserId", "descrition", "id", "isBlueBelt", "name", "updatedAt", "updatedByUserId") SELECT "categoryId", "createdAt", "createdByUserId", "descrition", "id", "isBlueBelt", "name", "updatedAt", "updatedByUserId" FROM "Technique";
