...
INSERT INTO "new_Technique" ("categoryId", "createdAt", "createdByUserId", "details", "id", "isBlueBelt", "name", "slug", "techniqueImage", "updatedAt", "updatedByUserId", "youtubeVideoId") SELECT "categoryId", "createdAt", "createdByUserId", "details", "id", "isBlueBelt", "name", "slug", "techniqueImage", "updatedAt", "updatedByUserId", "youtubeVideoId" FROM "Technique";
